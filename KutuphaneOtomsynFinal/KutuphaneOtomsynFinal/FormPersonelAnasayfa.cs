...
{
    public partial class FormPersonelAnasayfa : Form
    {
        public FormPersonelAnasayfa()
        {
            InitializeComponent();
        }

       
        private void FormPersonelAnasayfa_Load(object sender, EventArgs e)
        {
        ...
        {
            FormProfilAyarlariPersonel pf = new FormProfilAyarlariPersonel();
            selectedBar.Visible = true;
